	...
	function showInstructionPopUp(val, game, status){
		if(level==0) {
			startTime = new Date();
		}
		console.log(game);
		if (game != "" && game !== undefined){
			...
			showGameBoard_variable = game;
			if (status != "" && status !== undefined){
				status_experiment2 = status;
			}
			showGameBoard(showGameBoard_variable);
		}
	...
	// function showInstructionPopUp_main(val) {
	// 	if(level==0){
	// 		startTime = new Date();
	// 	}
	// 	showInstructions=val;
	// 	document.getElementById('instructions').style.display = showInstructions;
	// 	document.getElementById('wrapper').classList.remove('wrapper-hidden');
	// 	document.getElementById('first').classList.remove('wrapper-hidden');
	...
	function setVariables(){		
		...
		localStorage.setItem("showGameBoard_variable", showGameBoard_variable);
		localStorage.setItem("status_experiment2", status_experiment2);
	...
	function showGameBoard(val){
		showGameBoard_variable=val;
		document.getElementById('wrapper').style.display = showGameBoard_variable;
		setVariables();
	}
	function getVariables(){
		var x = document.URL;
		console.log(localStorage.getItem("experiment"));
		console.log(x.indexOf("index"))
		...
		showGameBoard_variable = localStorage.getItem("showGameBoard_variable");
		...
		status_experiment2 = localStorage.getItem("status_experiment2");
		...
		console.log("showGameBoard_variable-----------------", showGameBoard_variable);
		console.log("status_experiment2-----------------", status_experiment2);
		if(experiment!=0 && experiment<3){
			if (experiment == 2 && status_experiment2 === 'false'){
				console.log("false--------------------------")
				showGameBoard_variable = "none";
				showInstructions = "block";
			}else if (experiment == 2 && status_experiment2 === 'true'){
				console.log("true---------------------------------");
				showGameBoard_variable = "block";
				showInstructions = "none";
			}
			console.log("showInstructions-----------",showInstructions);
			console.log("wow experiement-------------",experiment);
